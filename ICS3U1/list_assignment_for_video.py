"""
-------------------------------------------------------------------------------
Name:		li_tony_list_assignment.py
...
def closeby(nums1, nums2):
    """
    With two given lists, return the number of times when their corresponding numbers are not equal but less than three apart.
